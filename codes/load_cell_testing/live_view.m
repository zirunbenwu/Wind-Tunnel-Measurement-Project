...
% LIVE_VIEW  Live HX711 load cell viewer with averaged points.
%
%   live_view('COM7')
%
% Pico must be running the HW14 streaming firmware (sending "0" enters
% stream mode). Close the figure to stop.
